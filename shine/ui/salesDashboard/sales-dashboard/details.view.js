sap.ui.jsview("sales-dashboard.details", {
	...
	*/ 
	createContent : function(oController) {
		  ...
		  var oSearchView = sap.ui.view({id:"so_search_view", viewName:"sales-dashboard.Search", type:sap.ui.core.mvc.ViewType.JS});		
	     ...
	     //Table Column Definitions
	      ...
	      this.oSHTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("SALES_ORDER_ID")}), 
	      ...
	      this.oSHTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("PARTNER_ID")}), 
	      ...
	      this.oSHTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("COMPANY")}), 
	      ...
	      this.oSHTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("CITY")}), 
	    	  template: oControl, sortProperty: "Buyer/CITY", filterProperty: "Buyer/CITY", filterOperator: sap.ui.model.FilterOperator.Contains }));

	     
	      oControl = new sap.ui.commons.TextView().bindText("GROSSAMOUNT",oController.numericFormatter); 
	      oControl.setTextAlign("End");
	      this.oSHTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("GROSS_AMOUNT")}), 
		  ...
		  oControl.setTextAlign("End");
		  this.oSHTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("TAX_AMOUNT")}), 
		         template: oControl, sortProperty: "TAXAMOUNT", hAlign: sap.ui.commons.layout.HAlign.End}));

	      oControl = new sap.ui.commons.TextView().bindProperty("text","CURRENCY");
	      this.oSHTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("CURRENCY")}), 
	     ...
	     this.oSHTable.bindRows({
	    	    ...
	    	    parameters: {expand: "Buyer",
	    	    	select: "SALESORDERID,CURRENCY,GROSSAMOUNT,TAXAMOUNT,PARTNERID,Buyer/COMPANYNAME,Buyer/CITY"},
	    	    sorter: sort1
	    	});
	    ...
	    this.oSITable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("SALES_ORDER_ITEM_ID")}), 
	    	template: oControl, sortProperty: "SALESORDERITEM", filterProperty: "SALESORDERITEM" }));
	    
	    //Product Id
	    oControl = new sap.ui.commons.TextView().bindProperty("text","PRODUCTID");
	    this.oSITable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("PRODUCT")}), 
	    ...
	    this.oSITable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("PRODUCT_NAME")}), 
	    	template: oControl, sortProperty: "PRODUCT_NAME", filterProperty: "PRODUCT_NAME" }));
	    
	    //Quantity
	    oControl = new sap.ui.commons.TextView().bindText("QUANTITY",oController.numericFormatter);
	    oControl.setTextAlign("End");
	    this.oSITable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("QUANTITY")}), 
	    	template: oControl, sortProperty: "QUANTITY",  hAlign: sap.ui.commons.layout.HAlign.End}));

	    //Quantity Unit	
	    oControl = new sap.ui.commons.TextView().bindProperty("text","QUANTITYUNIT");
	    this.oSITable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("QUANTITY_UNIT")}), 
	    ...
	    oControl.setTextAlign("End");
	    this.oSITable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("NET_AMOUNT")}), 
	    	template: oControl, sortProperty: "NETAMOUNT",  hAlign: sap.ui.commons.layout.HAlign.End}));
	    
	    
	  //Tax Amount
	    oControl = new sap.ui.commons.TextView().bindText("TAXAMOUNT",oController.numericFormatter);
	    oControl.setTextAlign("End");
	    this.oSITable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("TAX_AMOUNT")}), 
	    	template: oControl, sortProperty: "TAXAMOUNT",  hAlign: sap.ui.commons.layout.HAlign.End}));
	    
	    
	    //Currency
	    oControl = new sap.ui.commons.TextView().bindProperty("text","CURRENCY");
	    this.oSITable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: sap.app.i18n.getText("CURRENCY")}), 
	    	template: oControl, sortProperty: "CURRENCY", filterProperty: "CURRENCY" }));
	...
	createNewLineItemContent: function(oController){
      ...
      oItemTemplatePd.bindProperty("additionalText", { parts: [
    {path: "PRODUCT_PRICE", type: new sap.ui.model.type.Float({
        minFractionDigits: 2,
        maxFractionDigits: 2            
    })},
