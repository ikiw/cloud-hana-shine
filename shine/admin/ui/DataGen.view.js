...
function buildSettingsPanel(oController,oLayout){
    ...
    var oCB5 = new sap.ui.commons.CheckBox("cb5",{
        text : oBundle.getText("cb5"),
        tooltip : oBundle.getText("cbt5"),
        checked : false,
        change : function(oEvent){
        	  oController.toggleDateGenerate(oEvent,oController); }
    }); 
	...
	var oPOVal = new sap.ui.commons.TextField("POVal",{editable:true, visible: false, value: {path:"", type: oInt},	
	...
	var oSOVal = new sap.ui.commons.TextField("SOVal",{editable:true, visible: false, value: {path:"", type: oInt},	
		liveChange : function(oControlEvent){
...
//  For New DG    
	...
	var oDate1 = new sap.ui.commons.DatePicker("startDate", {yyyymmdd:startDateNum, visible: false});
    var oLabel3 = new sap.ui.commons.Label("lblStartDate", {text:oBundle.getText("lblSD"), labelFor:oDate1, visible: false});    
    var oDate2 = new sap.ui.commons.DatePicker("endDate", {yyyymmdd: TodayDateNum, visible: false, editable: true});    
    var oLabel4 = new sap.ui.commons.Label("lblEndDate", {text:oBundle.getText("lblED"), labelFor:oDate1, visible: false});
